...
#primero cargamos los noods
    marcas_uids = load_marcas(client, 'Dgraph/data/marcas.csv')
    categorias_uids = load_categorias(client, 'Dgraph/data/categorias.csv')
    productos_uids = load_productos(client, 'Dgraph/data/productos.csv')
    usuarios_uids = load_usuarios(client, 'Dgraph/data/usuarios.csv')

#despues cargar relaciones
    load_relaciones(client, "Dgraph/data/relacion_pertenece.csv", productos_uids, marcas_uids, "PERTENECE_A")
    load_relaciones(client, "Dgraph/data/relacion_en_categoria.csv", productos_uids, categorias_uids, "EN_CATEGORIA")
    load_relaciones(client, "Dgraph/data/relacion_compro.csv", usuarios_uids, productos_uids, "COMPRO")
    load_relaciones(client, "Dgraph/data/relacion_vio.csv", usuarios_uids, productos_uids, "VIO")
    load_relaciones(client, "Dgraph/data/relacion_favoritos.csv", usuarios_uids, productos_uids, "AGREGO_A_FAVORITOS")

    #generar diccionarios para simplificar el menu
    marcas_dicc = csv_a_diccionario('Dgraph/data/marcas.csv')
    categoria_dicc = csv_a_diccionario('Dgraph/data/categorias.csv')
    productos_dicc = csv_a_diccionario('Dgraph/data/productos.csv')
    usuarios_dicc = csv_a_diccionario('Dgraph/data/usuarios.csv')
